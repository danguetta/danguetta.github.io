...
layout: archive
title: "Exams"
permalink: /exam_review
author_profile: true
---

This page describes how I approach grading exams, and how I handle requests to see or re-grade your exam.

First, an important point - for most of my classes (homeworks, lectures, quizzes, etc...), the primary objective is learning. Thus, I give you full and extensive solutions, the TAs and I will happily discuss your solutions with you, and we'll generally be as transparent and open as possible. Sometimes, this gets in the way of fairness - for example, students who are more pushy about getting their homeworks re-graded might get a few extra points. But that's a price I'm willing to pay to make this a deeply effective and meaningful learning experience.

For the final exam, my priorities are reversed. I'd love you to learn something by taking the final exam, but my overwhelming priority is to assess you, and, crucially, to do it fairly. This is the fundamental driving principle behind all my exam policies.

Now, to specifics
  - I will never share either the exam paper, or its solutions, with anyone. These remain confidential so that I can re-use questions over the years. Why re-use questions? Simply because the newer an exam question is, the more likely it is the phrasing might be confusing, thus making the exam less fair. By combining old and new questions in each exam, I ensure the bulk of the exam is tried-and-tested and high-quality.
  - If the exam was a multiple-choice or numerical-answer-only exam, I will assume the grading was fair and not entertain any requests for re-grades or go through any exam with any student.
