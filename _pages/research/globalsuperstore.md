---
layout: archive
title: "The Global Superstore Case"
permalink: /research/globalsuperstore
author_profile: true
---

This page contains student files for the case "Modern Retail Analytics: Data Visualization Using Tableau," by Maxime Cohen, Daniel Guetta, and Matthieu Reed. It includes three detailed tutorials that can be used by instructors in the classroom to introduce students to Tableau in the context of retail strategy and operations (using the Global Superstore dataset that is made available with Tableau). We also wrote a homework assignment with detailed solutions.
...
This page contains
  - An [introduction](/files/research/globalsuperstore/TableauStoryline.pdf) and backstory for the case, which introduces the Global Superstore dataset and the data in question.
...
Looking for other case studies? We have case studies on [supply chain management and contracts](https://www8.gsb.columbia.edu/caseworks/node/674/Supply%2BChain%2BCoordination%2Band%2BContracts%2Bin%2Bthe%2BSharing%2BEconomy%2B-%2Ba%2BCase%2BStudy%2Bat%2BCargo) with a review copy available [here](https://danguetta.github.io/files/cases/cargo.pdf), [data science in peer-to-peer lending](https://danguetta.github.io/research/lc), text analytics ([part 1](https://www8.gsb.columbia.edu/caseworks/node/694/Evisort%253A%2BAn%2BAI-Powered%2BStart-up%2BUses%2BText%2BMining%2Bto%2BBecome%2BGoogle%2Bfor%2BContracts) and [review copy](https://danguetta.github.io/files/cases/evisort1.pdf), [part 2](https://www8.gsb.columbia.edu/caseworks/node/694) and [review copy](https://danguetta.github.io/files/cases/evisort2.pdf)), and [business analytics/python](https://danguetta.github.io/files/cases/dig.pdf). Make sure you also check out [XLKitLearn](https://danguetta.github.io/xlkitlearn/), a Python/Excel connector based on XLWings designed to teach data science.