...
You might also be interested in this [introductory video](https://drive.google.com/file/d/1k5TsDjVQb4stIRkLfs4Rscm4-hbpqihZ/view?usp=sharing) I used to introduce the add-in in my classes; it discusses the general mechanics of changing the add-in settings and running it.
